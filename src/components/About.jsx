        ...
        <div className='w-11/12 mx-auto py-20'>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 justify-items-center">
                ...
                <div className="w-full lg:w-10/12">
                    ...
                    <h2 className="font-extrabold text-5xl lg:text-6xl text-greenLg mb-2">We Believe that We</h2>
                    <h2 className="font-extrabold text-5xl lg:text-6xl text-greenLg mb-8">can Save More Life's with you</h2>
                    ...
                    <div className="flex items-center space-x-8 my-8">
                        <div>
                            <p className="font-bold text-xl mb-4 flex items-center">
