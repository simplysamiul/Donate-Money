...
const Header = () => {
    return (
        <div className='header-area top-3 -z-1'>
            <div className='header-container'>
                ...
                <div className='flex justify-center items-center space-x-8 mt-6'>
                    <button className='text-white bg-greenLg rounded-full text-xl font-bold p-6 border-greenLg shadow-md shadow-yellowOp btn'>Donate Now</button>
                    <button className='text-white bg-yellowOp rounded-full text-xl font-bold p-6 border-yellowOp shadow-md shadow-greenLg btn'>About Us</button>
                </div>
            </div>
